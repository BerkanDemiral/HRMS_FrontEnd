            ...
            <div>
                <Menu style={{ background: "#ffe066" }} pointing fixed="top" >
                    <Container>
                        ...
                        <Menu.Item icon="search" as={NavLink} to="/jobPostings" style={{ fontFamily: "Tahoma" }} name="İş ilanları" />
                        <Menu.Menu position="right">
                            {isAuthanticated ? <SignIn signOut={handleSignOut} a=""/> : <SignOut signIn={handleSignIn}  b=""/>}
                        </Menu.Menu>
                    </Container>
